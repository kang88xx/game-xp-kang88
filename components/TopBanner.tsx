...
export function TopBanner() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-12 max-w-6xl items-center justify-between gap-3 px-3 font-mono text-[10px] uppercase tracking-[0.12em] text-[#190501] sm:px-6 sm:text-[11px] sm:tracking-[0.18em]">
        {/* Left: live badge */}
        <span className="inline-flex shrink-0 items-center gap-2 rounded-full border border-black/25 px-2.5 py-1.5 sm:px-3">
